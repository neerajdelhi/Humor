     ...
     <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    <div class="navbar-brand" href="#">Humor Website</div>
...
<br><br>
 <form id="contact" action="<?= htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
		...
		<input type="text" name="name" placeholder="What is your name?" class="name" value="<?= $name ?>" >
        <span class="error"><?=  $name_error ?></span>
        <input type="text" placeholder="What is your email?" class="email" name="email" value="<?= $email ?>">
        <span class="error"><?= $email_error ?></span>
    <textarea value="<?= $message?>" tabinext="5" name="message" placeholder="Please enter your message" class="message" ></textarea>
...
<br><br><br>
  <footer class="text-center container-fluid" style="background-color:#fff66a">
      <h2>&copy; Neeraj Sharma</h3>
  </footer>
 </div>
</body>
</html>